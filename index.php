    ...
    <header>
        <nav class="nav-bar">
            <div class="logo">
                ...
                <img src="assests/swimcity.png" alt="SwimCity Logo" />
                <img src="assests/tw-joinery.jpg" alt="TW Joinery Logo" />
            </div>
            <ul>
    ...
    <main>
        <section class="hero">
            ...
            <div class="hero__content">
                <p class="hero__kicker">Grassroots Football — Sunderland</p>
                <h1 class="hero__title">Farringdon U12s</h1>
                <p class="hero__sub">
                    Community-driven youth football. Competing with passion, playing with respect.
                </p>

                <div class="hero__actions">
                    <a href="fixtures.html" class="btn btn--primary">View Fixtures</a>
                    <a href="gallery.html" class="btn btn--ghost">Gallery</a>
                </div>
            </div>

            <figure class="hero__inset">
                <img src="assests/tyler-shot.jpg" alt="Farringdon U12s match in progress" />
            </figure>
        </section>

        <section>
            <h1>Welcome to Farringdon Detached U12s</h1>
            <p>Building pride, teamwork, and inclusive football for every player.</p>
        </section>
        <section class="grid">
            <!-- Next Fixture -->
            <div class="card">
                <h3>Next Fixture</h3>
                <img src="assests/wfyfc.jpg" alt="wfyfc-logo" />
                <p><strong>Farringdon VS Whickham Fellside Youth FC</strong></p>
                <p>Date: Saturday, 27th September</p>
                <p>Venue: Highfield Academy</p>
                <p>Kick-off: 10:00 AM</p>
                <a href="#" class="btn">View Full Fixtures</a>
            </div>

            <!-- Latest Gallery -->
            <div class="card">
                <h3>Latest Gallery</h3>
                <img src="gallery/1 (310).jpg" alt="Match Action" />
                <p>Catch up on the latest match highlights in our photo gallery.</p>
            ...
            <div class="card">
                ...
                <img src="assests/tw-joinery.jpg" alt="Sponsor Logo" class="logo" />
        ...
        <section class="news-section">
            ...
            <div class="news-grid">
                <div class="news-card">
                    <img src="assests/bradley-goal.jpg" alt="News 1">
                    <div class="news-content">
                        <h3>Matchday Victory</h3>
                        <div class="news-meta">Sept 23, 2025 • Club News</div>
                        <p>Our team secured a win the league cup against Wrekenton Nou Camp Reds, thanks to Bradley for getting us the match winning goal!.</p>
                        <a href="news1.html" class="read-more">Read More</a>
                    </div>
                </div>

                <div class="news-card">
                    <img src="assests/jjd.jpg" alt="News 2">
                    <div class="news-content">
                        <h3>New Signing Announced!</h3>
                        <div class="news-meta">Sept 20, 2025 • Transfers</div>
                        <p>We are delighted to welcome our new forward Joey!, strengthening the squad for the upcoming season. Here he is celebrating a joint parents player award with fellow Winger David and MOTM performance from Jenson</p>
                        <a href="news2.html" class="read-more">Read More</a>
                    </div>
                </div>

                <div class="news-card">
                    <img src="assests/fitness.jpg" alt="News 3">
                    <div class="news-content">
                        <h3>Tuesday Training</h3>
                        <div class="news-meta">Sept 9, 2025 • Community</div>
                        <p>Here at Farringdon we highlight the importance of staying fit for games and how crucial it can make a differnce to winning games. Here the lads undergo the bleep test every two weeks.</p>
        ...
        <section class="team-intro">
            <h2>Meet Our Team</h2>
            <p class="team-sub">Our talented squad of young footballers representing Farringdon Detached in RFYL Division 9.</p>

            <div class="team-stats">
                <div class="stat-box">
                    <span class="stat-icon">⚽</span>
                    <p><strong>14</strong> Players</p>
                </div>
                <div class="stat-box">
                    <span class="stat-icon">🥅</span>
                    <p><strong>1</strong> Total Goals</p>
                </div>
                <div class="stat-box">
                    <span class="stat-icon">🏆</span>
                    <p><strong>9</strong> RFYL</p>
                </div>
                <div class="stat-box">
                    <span class="stat-icon">📅</span>
                    <p><strong>2025–2026</strong> Season</p>
                </div>
            </div>
        </section>
        ...
        <section class="formation">
            ...
            <div class="field">
                <!-- Goalkeeper -->
                <div class="player" data-player="finley">
                    <span>1</span>
                    <p>Finley</p>
                ...
                <br />
                <!-- Defenders -->
                <div class="player" data-player="bradley"><span>8</span><p>Bradley</p></div>
                <div class="player" data-player="kaeton"><span>4</span><p>Kaeton</p></div>
                <div class="player" data-player="freddie"><span>5</span><p>Freddie</p></div>
                <div class="player" data-player="oliver"><span>11</span><p>Oliver</p></div>
                <div class="player" data-player="lucas"><span>6</span><p>Lucas</p></div>
                <br />
                <!-- Midfielders -->
                <div class="player" data-player="david"><span>3</span><p>David</p></div>
                <div class="player" data-player="jensen"><span>7</span><p>Jensen</p></div>
                <div class="player" data-player="joseph"><span>16</span><p>Joseph</p></div>
                <div class="player" data-player="jenson"><span>12</span><p>Jenson</p></div>
                <br />
                <!-- Forwards -->
                <div class="player" data-player="dawson"><span>9</span><p>Dawson</p></div>
                <div class="player" data-player="tyler"><span>10</span><p>Tyler</p></div>
                <div class="player" data-player="sohny"><span>18</span><p>Sonny</p></div>
                <div class="player" data-player="joey"><span>14</span><p>Joey</p></div>
            </div>
            ...
            <div class="profile-overlay" id="profile-overlay">
                <div class="profile-card" id="profile-card">
                    ...
                    <button class="close-profile">Close</button>
                </div>
            </div>
